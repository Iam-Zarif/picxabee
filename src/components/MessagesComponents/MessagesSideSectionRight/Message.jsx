    ...
    <div ref={ref}>
      {message.senderId === user?.uid ? (
        <div className="chat chat-end">
          ...
          <div className="flex flex-col items-end justify-center bg-primary-color rounded-md my-2">
        ...
        <div className="chat chat-start">
          ...
          <div className="flex flex-col items-start justify-center bg-primary-color rounded-md my-2">
          {/* {message.img && <img src={message.img} className="w-1/3 py-2 pb-3 rounded-3xl" alt="" />} */}
         {message.img  && <img  className="w-1/3 py-2 pb-3 rounded-3xl" src={message.img} alt="" />}
            <p className="chat-bubble mr-1 text-black font-medium md:text-sm text-xs">{message.text}</p>
          </div>
