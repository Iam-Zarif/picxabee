...
const CreatePost = () => {
  ...
  const handleImage = async (e) => {
    ...
    const url = "https://api.imgbb.com/1/upload?expiration=600&key=f3218173624c8aebe56d3c415677e482";
    ...
    <>
      {user && (
        <section className="relative bg-[#D2D2D2] p-4 bg-opacity-30 shadow-sm  mx-auto mt-3 rounded-md">
          <div className="">
            <h1 className="text-center font-semibold text-lg py-2">Share your thoughts</h1>
          </div>
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="px-5">
              ...
              <div className="mt-5">
                {loading && (
                  <BeatLoader color="#349999" loading margin={4} size={10} speedMultiplier={1} />
                )}
                {imageURL && (
                  <Image
                    src={imageURL}
              ...
              <div className="flex justify-between mt-6 items-center">
                <div className="flex gap-x-2">
                  <label className="custom-file-upload">
                    ...
                    />
                    <BsImageFill className="text-primary-color dark:text-black" size={22} />
                  </label>
                </div>
