        ...
        <div className={`${styles.imageContainer} relative `}>
          ...
          {user?.email !== email ? (
            ...
            <div className="absolute right-5 bottom-5">
              <input type="file" id="profile-btn" onChange={handleCoverPhoto} hidden />
              <label for="profile-btn">
                <HiMiniPencilSquare size={30} className="text-white cursor-pointer" />
              </label>
            </div>
          )}
        </div>
                ...
                <div className={`${styles.profilePic} bg-white rounded-md`}>
                  ...
                  {user?.email !== email ? (
                    ...
                    <div className="absolute bottom-1 right-1">
                      <input type="file" id="actual-btn" onChange={handleProfilePicture} hidden />
