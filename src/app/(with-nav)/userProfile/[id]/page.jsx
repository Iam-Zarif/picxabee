...
const UserProfile = ({ params }) => {
    ...
    return (
        // Me the Zarif responsiveness
        <>
            <Navbar />

            <div className='my-container mt-20'>
                <div className='border rounded-md lg:h-[40vh]'>
                    <Image
                        ...
                        height={384}
                        objectFit='cover'
                        className='lg:h-[384px] h-[25vh] w-full'
                        alt='cover photo'
                    />
                </div>
                    ...
                    <div className='flex '>
                        <div className=" mx-10 overflow-hidden -mt-16">
                            <Image
                                ...
                                objectFit='cover'
                                alt='Profile Pic'
                                className='lg:h-40 lg:w-40  rounded-md bg-cover'
                            />
                        </div>

                        <div className='text-left mt-3 lg:w-1/4 opacity-80'>
                ...
                <div className='grid grid-cols-9 gap-5 lg:mx-20'>

                    <div className='lg:col-span-4 col-span-9 border h-[300px] w-full rounded-md p-5'>
