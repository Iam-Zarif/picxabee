...
import {AiOutlinePlusCircle,  AiOutlineHeart,AiOutlineArrowRight,AiOutlineProfile,AiOutlineQuestionCircle,AiOutlineUser } from 'react-icons/ai';
...
const Navbar = () => {
  ...
  const navItems = <> 
   <li>
      <a
        ...
        className="flex items-center   hover:scale-125 hover:translate-x-1 transform transition-transform "
      >
        <GoHome   className="text-2xl lg:text-2xl " />
        
      </a>
    </li>
    <li><a className='hover:bg-transparent hover:scale-125 transform transition-transform '>
      ...
      <li className='hidden lg:block'><a className='indicator hover:bg-transparent  hover:scale-125 transform transition-transform'>
      ...
      <AiOutlineUser   className='text-2xl lg:text-2xl hover:scale-125 hover:translate-x-1 transform transition-transform' onClick={toggleDrawer}>Show</AiOutlineUser>
 ...
 flex flex-col gap-5 w-4/5 mx-auto mt-12   rounded-xl ">
     ...
     <p className=" "><AiOutlineUser className='inline'/> User Full Name</p>
  ...
  <div className="navbar-start">
    ...
    {/* responsive dropdown */}
    <a className=" logo normal-case text-xl lg:text-3xl hidden lg:block lg:mb-5"> <span className='text-5xl'>P</span>icxa<span className='  '>bee</span></a>
...
<div className='fixed py-4 top-0 w-full left-0 bg-slate-100 pb-4 shadow-md shadow-slate-300 flex justify-between px-10 items-center lg:hidden' ref={navbarRef}>
  {/* Logo */}
  <div>
